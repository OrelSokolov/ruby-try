...
shared_context "#try, block given" do
  it "should return value for general method" do
    subject.try{|obj| obj.get_zero}.should eq(0)
  end

  it "should raise error for non-existing method" do
    expect{ subject.try{|obj| obj.non_existing_method} }.to raise_error(NoMethodError)
  end
end
...
describe Object do
  ...
  describe "#try" do
    ...
    context "when block given" do
      include_context "#try, block given"
    end
  ...
  describe "#try!" do
    context "when method passed as argument" do
      context "for existing method" do
        it "should return value for general method" do
          subject.try!(:get_zero).should eq(0)
        end
